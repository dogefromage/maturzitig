    ...
    interactions: [
      new Interaction({
        ...
        dialogue: [
            ...
            new Sentence('*tiefes Einatmen* '),
            new Sentence('Wie man merkt, bin ich ein Deutscher, deswegen spreche ich mit dir auch nur Hochdeutsch. Ich bin aus Köln und höre vielleicht auch deswegen leidenschaftlich gerne Kölschrock. '),
            new Sentence('*tiefes Einatmen*'),
            new Sentence('Wie es dir vielleicht bereits aufgefallen ist, atme ich immer wieder sehr tief und vor allem laut ein, wieso? Das ist eine gute Frage.'),
    ...
    interactions: [
      new Interaction({
        ...
        dialogue: [
            ...
            new Sentence('Au wenn i immerwieder usversehe gseit han, dass s euses gliebte Düsterwald Ewacht oder ufschloft, bin i trotzdem akzeptiert worde. Das macht mi stolz.'),
